...
# opening and closing applications..
        ...
        #     cv2.destroyAllWindows()
            ...
            ob = "C:\\Program Files (x86)\\BraveSoftware\\Brave-Browser\\Application"
            os.startfile(ob)
        ...
        #     os.startfile("TASKKILL /f /im brave.exe")
...
# sending email with attachments
            ...
            #     server.sendmail(email, send_to_email, message)
            #     server.quit()
            #     speak("email has been sent to pratik")
...
# Instagram profile
            ...
            if "yes" in condition:
                ...
                speak("okay sir i won't download the profile picture")
...
# ------------------------Hiding Files------------------------
            ...
            if "yes" in query or "unhide" in query:
                os.system("attrib -h /s /d")
                speak("sir, all the files in this folder are now visible for everyone, i wish you are taking this descision in your own peace")
...
# sleep commands
        ...
        elif "you can sleep" in query or "sleep now" in query or "sleep" in query or "pause listening" in query:
            speak("okay sir, i am going to sleep now, you can call me anytime.")
            break
...
# Open Browser in private mode
        elif "private mode" in query or "open browser privately" in query:
...
# youtube video downloader
        # elif "download video" in query or "video downloader" or "download youtube video" in query or "download video" in query:
        #     root = Tk()
        #     root.geometry("500x300")
        #     root.resizable(0, 0)
        #     root.title("Youtube Video Downloader")
        #     speak("Enter Youtube Video URL here!")
        #     Label(root, text="Youtube Video Downloader",
        #           font="arial 15 bold").pack()
        #     link = StringVar()
        #     Label(root, text="paste Youtube video URL here",
...
# Face Recognition
        elif "face recognition" in query or "recognize face" in query or "recognise face" in query:
            speak("Activating Face recognition")
            os.system("testrecfinalwith4pix.py")

# Door Unlocking
        elif "door unlocking" in query or "Unlock door" in query:
            speak("Activating Door unlock, Please verify by Showing your Face")
            os.system("doorunlock.py")

# Mask Detection
        elif "mask detection" in query or "detect mask" in query:
            speak("Activating Mask Detection")
            os.system("mask_detect.py")
...
if __name__ == "__main__":
    while True:
        ...
        if "wake up" in permission or "turn on" in permission or "activate" in permission or "sara" in permission or "start listening" in permission:
            TaskExecution()
        elif "goodbye" in permission or "terminate" in permission or "quit" in permission or "switch off" in permission or "stop listening" in permission:
...
# connection checker(airplane mode and bluetooth)
# internet exception
# pause,next ,previous
